...
namespace Codeworx.Dynamic
{
    public class TransactionProxyHelper
    {
        ...
        public static void SetCollectionValue<TValue,TCollection, TTarget>(Dictionary<Key<TCollection>, List<TTarget>> dictionary,ICollection<TValue> targetCollection) where TCollection : IEnumerable<TValue>
        {
