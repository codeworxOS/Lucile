...
function New-NugetPackages {
    ...
    PROCESS {
        ...
        $projects | foreach { 
            ...
            Start-Process dotnet -ArgumentList "msbuild $_ -nodeReuse:false -verbosity:d -p:UseRazorBuildServer=false -p:UseSharedCompilation=false -property:`"$params`" -target:pack" -NoNewWindow -PassThru -Wait
